...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-nav-tree">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child module" data-node-id="xxx">
                            <dd><a href="movie.html" target="ifmMain">图书管理</a></dd>
                            <dd><a href="review.html" target="ifmMain">短评管理
                                </a></dd>
                        </dl>
                    </li>
    ...
    <div class="layui-body" style="overflow-y: hidden">
        <iframe name="ifmMain" style="border: 0px;width: 100%;height: 100%" src="movie.html"></iframe>
    </div>
    <!--版权信息-->
