...
<html lang="en"><head>
    ...
    <script type="text/html" id="tpl">
        <a href="/movie/{{bookId}}" style="color: inherit">
            <div class="row mt-2 book">
                <div class="col-4 mb-2 pr-2">
                    <img class="img-fluid" src="./resources/movies/1.png">
                </div>
...
<div class="container">
    <nav class="navbar navbar-light bg-white shadow mr-auto">
        <ul class="nav">
            <li class="nav-item">
                <a href="/">
                    <img src="./resources/movies/logo.png" class="mt-1" style="width: 100px">
                </a>
            </li>
